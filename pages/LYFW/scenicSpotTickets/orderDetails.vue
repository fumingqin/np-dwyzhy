	...
	<view>
		...
		<view class="Xx_view">
			...
			<view class="Xx_contentView">
				...
				<view class="Xx_contentBlock" >
					<text class="Xx_contentTitle">预约入园时间</text>
				...
				<!-- 空白二维码区域 -->
				<view class="Xx_QRcodeViewBlank" v-if="orderInfo.orderType == '待支付' || orderInfo.orderType == '已取消' || orderInfo.orderType == '待确认'">支付后生成二维码及取票码</view>

				<!-- 空白二维码区域 -->
				<view class="Xx_QRcodeViewBlank" v-if="orderInfo.orderType == '已退票'">二维码已失效</view>

				<!-- 二维码 -->
				<view class="Xx_QRcodeView" :hidden="orderInfo.orderType == '待支付' || orderInfo.orderType == '已取消' || orderInfo.orderType == '待确认' || orderInfo.orderType == '已退票' ">
